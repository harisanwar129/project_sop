...
class item_m extends CI_Model
{
    ...
    // start datatables
    var $column_order = array('item_id', 'barcode', 'item.name', 'category_name', 'unit_name', 'price', 'stock'); //set column field database for datatable orderable
    var $column_search = array('barcode', 'item.name', 'category.name', 'price'); //set column field database for datatable searchable
